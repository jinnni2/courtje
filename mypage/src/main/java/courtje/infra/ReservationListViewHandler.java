...
import courtje.config.kafka.KafkaProcessor;
...
public class ReservationListViewHandler {
    ...
    public void whenCourtReserved_then_CREATE_1(
        ...
        try {
            ...
            reservationList.setReserveId(String.valueOf(courtReserved.getId()));
            reservationList.setCourtName(courtReserved.getCourtName());
    ...
    @StreamListener(KafkaProcessor.INPUT)
    public void whenCourtCanceled_then_UPDATE_1(
        ...
        try {
            ...
            List<ReservationList> reservationListList = reservationListRepository.findByReserveId(
                String.valueOf(courtCanceled.getId())
            );
    ...
    @StreamListener(KafkaProcessor.INPUT)
    public void whenFullyBooked_then_UPDATE_2(
